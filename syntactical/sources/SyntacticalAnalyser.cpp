...
const struct transition program[PROGRAM_FSM_SIZE] = {
    {PROGRAM,    true,  (int) lexical::token_type::INT, STATEMENT0},
    // Bloco ASSIGN
    {STATEMENT0, true,  (int) lexical::token_type::LET, ASSIGN0},
    {ASSIGN0,    true,  (int) lexical::token_type::IDN, ASSIGN1},
    {ASSIGN1,    true,  (int) lexical::token_type::EQL, ASSIGN2},
    {ASSIGN2,    false, (int) syntax::type::EXP,        ASSIGN3},
    {ASSIGN3,    true,  (int) lexical::token_type::INT, STATEMENT0},
    // Bloco READ
    {STATEMENT0, true,  (int) lexical::token_type::READ, READ0},
    {READ0,      false, (int) syntax::type::VAR,         READ1},
    {READ1,      true,  (int) lexical::token_type::COM,  READ2},
    {READ1,      true,  (int) lexical::token_type::INT,  STATEMENT0},
    {READ2,      false, (int) syntax::type::VAR,         READ1},
    // Bloco DATA
    {STATEMENT0, true,  (int) lexical::token_type::DATA, DATA0},
    {DATA0,      false, (int) syntax::type::NUM,         DATA1},
    {DATA1,      true,  (int) lexical::token_type::COM,  DATA2},
    {DATA1,      true,  (int) lexical::token_type::INT,  STATEMENT0},
    {DATA2,      false, (int) syntax::type::NUM,         DATA1},
    // Bloco PRINT
    {STATEMENT0, true,  (int) lexical::token_type::PRINT, PRINT0},
    {PRINT0,     false, (int) syntax::type::EXP,          PRINT1},
    {PRINT0,     true,  (int) lexical::token_type::STR,   PRINT2},
    {PRINT0,     true,  (int) lexical::token_type::INT,   STATEMENT0},
    {PRINT1,     true,  (int) lexical::token_type::COM,   PRINT0},
    {PRINT1,     true,  (int) lexical::token_type::INT,   STATEMENT0},
    {PRINT2,     true,  (int) lexical::token_type::COM,   PRINT0},
    {PRINT2,     true,  (int) lexical::token_type::INT,   STATEMENT0},
    {PRINT2,     false, (int) syntax::type::EXP,          PRINT1},
    // Bloco GOTO
    {STATEMENT0, true,  (int) lexical::token_type::GO,   GOTO0},
    {STATEMENT0, true,  (int) lexical::token_type::GOTO, GOTO1},
    {GOTO0,      true,  (int) lexical::token_type::TO,   GOTO1},
    {GOTO1,      true,  (int) lexical::token_type::INT,  GOTO2},
    {GOTO2,      true,  (int) lexical::token_type::INT,  STATEMENT0},
    // Bloco IF
    {STATEMENT0, true,  (int) lexical::token_type::IF,   IF0},
    {IF0,        false, (int) syntax::type::EXP,         IF1},
    {IF1,        true,  (int) lexical::token_type::GEQ,  IF2},
    {IF1,        true,  (int) lexical::token_type::GTN,  IF2},
    {IF1,        true,  (int) lexical::token_type::NEQ,  IF2},
    {IF1,        true,  (int) lexical::token_type::LTN,  IF2},
    {IF1,        true,  (int) lexical::token_type::LEQ,  IF2},
    {IF1,        true,  (int) lexical::token_type::EQL,  IF2},
    {IF2,        false, (int) syntax::type::EXP,         IF3},
    {IF3,        true,  (int) lexical::token_type::THEN, IF4},
    {IF4,        true,  (int) lexical::token_type::INT,  IF5},
    {IF5,        true,  (int) lexical::token_type::INT,  STATEMENT0},
    // Bloco FOR
    {STATEMENT0, true,  (int) lexical::token_type::FOR,  FOR0},
    {FOR0,       true,  (int) lexical::token_type::IDN,  FOR1},
    {FOR1,       true,  (int) lexical::token_type::EQL,  FOR2},
    {FOR2,       false, (int) syntax::type::EXP,         FOR3},
    {FOR3,       true,  (int) lexical::token_type::TO,   FOR4},
    {FOR4,       false, (int) syntax::type::EXP,         FOR5},
    {FOR5,       true,  (int) lexical::token_type::STEP, FOR6},
    {FOR5,       true,  (int) lexical::token_type::INT,  STATEMENT0},
    {FOR6,       false, (int) syntax::type::EXP,         FOR7},
    {FOR7,       true,  (int) lexical::token_type::INT,  STATEMENT0},
    // Bloco NEXT
    {STATEMENT0, true,  (int) lexical::token_type::NEXT, NEXT0},
    {NEXT0,      true,  (int) lexical::token_type::IDN,  NEXT1},
    {NEXT1,      true,  (int) lexical::token_type::INT,  STATEMENT0},
    // Bloco DIM
    {STATEMENT0, true,  (int) lexical::token_type::DIM, DIM0},
    {DIM0,       true,  (int) lexical::token_type::IDN, DIM1},
    {DIM1,       true,  (int) lexical::token_type::PRO, DIM2},
    {DIM2,       true,  (int) lexical::token_type::INT, DIM3},
    {DIM3,       true,  (int) lexical::token_type::PRC, DIM4},
    {DIM4,       true,  (int) lexical::token_type::COM, DIM5},
    {DIM4,       true,  (int) lexical::token_type::INT, STATEMENT0},
    {DIM5,       true,  (int) lexical::token_type::IDN, DIM1},
    // Bloco DEF
    {STATEMENT0, true,  (int) lexical::token_type::DEF, DEF0},
    {DEF0,       true,  (int) lexical::token_type::FN,  DEF1},
    {DEF1,       true,  (int) lexical::token_type::IDN, DEF2},
    {DEF2,       true,  (int) lexical::token_type::PRO, DEF3},
    {DEF3,       true,  (int) lexical::token_type::IDN, DEF4},
    {DEF4,       true,  (int) lexical::token_type::PRC, DEF5},
    {DEF5,       true,  (int) lexical::token_type::EQL, DEF6},
    {DEF6,       false, (int) syntax::type::EXP,        DEF7},
    {DEF7,       true,  (int) lexical::token_type::INT, STATEMENT0},
    // Bloco GOSUB
    {STATEMENT0, true,  (int) lexical::token_type::GOSUB, GOSUB0},
    {GOSUB0,     true,  (int) lexical::token_type::INT,   GOSUB1},
    {GOSUB1,     true,  (int) lexical::token_type::INT,   STATEMENT0},
    // Bloco RETURN
    {STATEMENT0, true,  (int) lexical::token_type::RETURN, RETURN},
    {RETURN,     true,  (int) lexical::token_type::INT, STATEMENT0},
    // Bloco REM
    {STATEMENT0, true,  (int) lexical::token_type::REM, REMARK0},
    {REMARK0,    true,  (int) lexical::token_type::CMT, REMARK1},
    {REMARK1,    true,  (int) lexical::token_type::INT, STATEMENT0},
    // Bloco END
    {STATEMENT0, true,  (int) lexical::token_type::END, END},
};
        ...
        for (int i = 0; i < PROGRAM_FSM_SIZE; i++) {
            if (program[i].current.id == s.id) {
                if (program[i].input_is_terminal) {
                    if ((lexical::token_type) program[i].input == tk.type ) {
                        t = &program[i];
                        tk = lex.get_next();
                    ...
                    && (tk.type == lexical::token_type::ADD || tk.type == lexical::token_type::SUB || tk.type == lexical::token_type::INT)
                    && FSM_num(lex)
                ){
                    t = &program[i];
                    break;
                }
                else if ((type)program[i].input == type::VAR && tk.type == lexical::token_type::IDN && FSM_var(lex)) {
                    t = &program[i];
                    break;
                }
        ...
        for (int i = 0; i < EXP_FSM_SIZE; i++) {
            if (exp[i].current.id == s.id) {
                if (exp[i].input_is_terminal) {
                    if ((lexical::token_type)exp[i].input == tk.type) {
                        t = &exp[i];
                        tk = lex.get_next();
                        break;
                    }
        ...
        for (int i = 0; i < EB_FSM_SIZE; i++) {
            if (eb[i].current.id == s.id) {
                if (eb[i].input_is_terminal) {
                    if ((lexical::token_type)eb[i].input == tk.type) {
                        t = &eb[i];
                        tk = lex.get_next();
                        break;
                    }
                ...
                else if ((type)eb[i].input == type::VAR && tk.type == lexical::token_type::IDN && FSM_var(lex)) {
                    t = &eb[i];
                    break;
                }
